...
import ai.whylabs.services.whylogs.kafka.JSONObjectDeserializer
...
enum class EnvVarNames(private val default: String? = null) {
    ...
    // TODO how are we going to support complex things here? Maybe avro schemas?
    // For v1 Lets just assume everything is going to be a flat key value structure
    KAFKA_KEY_DESERIALIZER(StringDeserializer::class.java.toString()),
    KAFKA_VALUE_DESERIALIZER(JSONObjectDeserializer::class.java.toString()),
